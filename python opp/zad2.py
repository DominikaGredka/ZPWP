class Library:
    ...
    def __str__(self):
        return (f"Biblioteka informacje: "
                f"miasto {self.city}, "
                f"ul.{self.street}, "
...
library2 = Library('Warszawa', 'Piotrkowska 30', '73-948', '10:00 - 22:00', '22 158 15 18')
...
employee1 = Employee('Jan', 'Wolny', '15.03.2020', '18,06,2003', 'Katowice', 'Graniczna 5', '40-562', '521789318')
employee2 = Employee("Jane", "Smith", '2022-02-01', '1985-08-20', 'Wrocław', 'Pocztowa 66', '56-655', '532168439')
employee3 = Employee("Bob", "Johnson", '2022-03-01', '1995-11-10', 'Warszawa', "Leśna 33", '61-854', '596172943')
